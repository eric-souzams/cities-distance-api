package com.project.citiesapi.cities.service;
...
public class DistanceService {
     ...
     * @return
     */
    public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadiusService unit) {
     ...
     * @return
     */
    public Double distanceUsingPoints(final Long city1, final Long city2, final EarthRadiusService unit) {
    ...
    private double doCalculation(final double lat1, final double lon1, final double lat2,
                                 final double lng2, final EarthRadiusService earthRadius) {
